<div class="lg:max-w-screen-xl mx-4 lg:m-auto block pb-40 relative ">
		...
		<div class="flex flex-col justify-center items-center w-full my-32">
			...
			<div class="text-3xl font-thin mt-4">This means that this URL you just tried doesn't exist.</div>
		</div>
		...
		<div class="flex">
				...
				// └─────────────────────────────────────────────────────────────────────────┘
				?>
				<a href="/tutorials" class="flex flex-col relative w-1/3 p-4 bg-gray-200 fill-green-500 rounded-2xl overflow-hidden hover:fill-white hover:text-white hover:bg-green-500" >

					<img class="z-30 h-60 m-auto" src="<?php echo do_shortcode('[facts fact="taxonomy_random_acf_image" tax="tutorial_category"]');?>"/>
				...
				// └─────────────────────────────────────────────────────────────────────────┘
				?>
				<a href="/demonstrations" class="flex flex-col relative w-1/3 p-4 mx-4 bg-gray-200 fill-blue-500 rounded-2xl overflow-hidden hover:fill-white hover:text-white hover:bg-blue-500" >

					<img class="z-30 h-60 m-auto" src="<?php echo do_shortcode('[facts fact="taxonomy_random_acf_image" tax="demonstration_category"]'); ?>"/>
				...
				// └─────────────────────────────────────────────────────────────────────────┘
				?>
				<a href="/blogs" class="flex flex-col relative w-1/3 bg-gray-200 rounded-2xl fill-yellow-500 overflow-hidden hover:fill-white hover:text-white hover:bg-yellow-500" >
