anime__punchin('.c-hero-panel__classes .c-hero-panel__overlay', 50, 'T');
anime__punchin('.c-hero-panel__classes .c-hero-panel__xxl', 150, 'T');
anime__punchin('.c-hero-panel__classes .c-hero-panel__description', 200, 'T');
