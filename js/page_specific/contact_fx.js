...
anime__punchin('.c-hero-panel__header-contact .c-hero-panel__overlay', 50, 'R');
anime__punchin('.c-hero-panel__header-contact .c-hero-panel__xxl', 150, 'T');
anime__punchin('.c-hero-panel__header-contact .c-hero-panel__description', 200, 'L');
